...
public sealed class Pcap1_5 extends Pcap1_2 permits Pcap1_9 {
	...
	/**
	 * @see {@full pcap_t *pcap_open_dead_with_tstamp_precision(int linktype, int
	...
	/**
	 * @see {@full int pcap_set_immediate_mode(pcap_t *p, int immediate_mode)}
	 * @since libpcap 1.5
	 */
	private final static PcapForeignDowncall pcap_set_immediate_mode;

	/**
	 * @see {@full int pcap_set_tstamp_precision(pcap_t *p, int tstamp_precision)}
	 * @since libpcap 1.5
	 */
	private final static PcapForeignDowncall pcap_set_tstamp_precision;

	/**
	 * @see {@full int pcap_get_tstamp_precision(pcap_t *p)}
	 * @since libpcap 1.5
	 */
