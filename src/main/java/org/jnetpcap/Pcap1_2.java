...
public sealed class Pcap1_2 extends Pcap1_0 permits Pcap1_5 {
	...
	/**
	 * @see {@full int pcap_list_tstamp_types(pcap_t *p, int **tstamp_typesp)}
	 * @since libpcap 1.2
	 */
	private static final PcapForeignDowncall pcap_list_tstamp_types;

	/**
	 * @see {@full void pcap_free_tstamp_types(int *tstamp_types)}
	 * @since libpcap 1.2
	 */
	private static final PcapForeignDowncall pcap_free_tstamp_types;

	/**
	 * @see {@full int pcap_set_tstamp_type(pcap_t *p, int tstamp_type)}
	 * @since libpcap 1.2
	 */
