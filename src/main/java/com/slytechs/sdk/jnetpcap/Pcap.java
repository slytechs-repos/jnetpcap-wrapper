...
import com.slytechs.sdk.jnetpcap.constant.PcapOption;
...
public abstract sealed class Pcap implements AutoCloseable permits Pcap0_4 {
	...
	public interface LibraryPolicy {
		 ...
		 */
		String SYSTEM_PROPERTY_LIBPCAP_FILE = "com.slytechs.sdk.jnetpcap.libpcap.file";
		 ...
		 */
		String SYSTEM_PROPERTY_LIBPCAP_FILENAME = "com.slytechs.sdk.jnetpcap.libpcap.filename";
		 ...
		 * 'java.library.path'
		 */
		String SYSTEM_PROPERTY_LIBPCAP_NAMES = "com.slytechs.sdk.jnetpcap.libpcap.names";
		 ...
		 */
		String SYSTEM_PROPERTY_SO_IGNORE_LOAD_ERRORS = "com.slytechs.sdk.jnetpcap.so.ignoreLoadErrors";
		 ...
		 * </dl>
		 */
		String SYSTEM_PROPERTY_ABI = "com.slytechs.sdk.jnetpcap.abi";
	...
	public static sealed class Unix extends Pcap1_10 permits Pcap.Linux {
		 ...
		 * @throws PcapException the pcap exception
		 * @see com.slytechs.sdk.jnetpcap.Pcap0_8#getSelectableFd()
		 */
		@Override
	 ...
	 * <p>
	 * For example {@code Pcap.checkVersion(Pcap.VERSION)} when compiled, the
