...
import static com.slytechs.sdk.jnetpcap.internal.UnsafePcapHandle.*;
...
import com.slytechs.sdk.jnetpcap.internal.ForeignUtils;
import com.slytechs.sdk.jnetpcap.internal.PcapDispatcher;
...
import com.slytechs.sdk.jnetpcap.internal.PcapStatRecord;
import com.slytechs.sdk.jnetpcap.internal.StandardPcapDispatcher;
...
public sealed class Pcap0_4 extends Pcap permits Pcap0_5 {
	...
	public void close() {
		if (closed) {
			System.err.println("Pcap0_4::close error, trying to close a closed handle");
			return;
		}
