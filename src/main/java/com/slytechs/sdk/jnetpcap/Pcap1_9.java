 ...
 *
 */
public sealed class Pcap1_9 extends Pcap1_5 permits Pcap1_10 {

	/**
	 * The Constant pcap_bufsize.
	 *
	 * @see {@code int pcap_bufsize(pcap_t *)}
	 * @since libpcap 1.9
	 */
	private static final PcapForeignDowncall pcap_bufsize;

	static {
		try (var foreign = new PcapForeignInitializer(Pcap1_9.class)) {

			// @formatter:off
			pcap_bufsize        = foreign.downcall("pcap_bufsize(A)I");
			// @formatter:on
	 ...
	 */	public static boolean isSupported() {
		return pcap_bufsize.isNativeSymbolResolved();
	}
	 ...
	 * @since libpcap 0.6
	 */
	public static Pcap1_9 openDead(PcapDlt linktype, int snaplen) throws PcapException {
		return Pcap0_6.openDead(Pcap1_9::new, linktype, snaplen);
	}
	 ...
	 * @since libpcap 1.5.1
	 */
	public static Pcap1_9 openDeadWithTstampPrecision(PcapDlt linktype, int snaplen, PcapTStampPrecision precision)
			throws PcapException {
		return Pcap1_5.openDeadWithTstampPrecision(Pcap1_9::new, linktype, snaplen, precision);
	}
	 ...
	 * @since libpcap 0.4
	 */
	public static Pcap1_9 openLive(String device,
			int snaplen,
			boolean promisc,
			long timeout,
			TimeUnit unit) throws PcapException {

		return Pcap0_4.openLive(Pcap1_9::new, device, snaplen, promisc, timeout, unit);
	}
	 ...
	 * @since libpcap 0.4
	 */
	public static Pcap1_9 openOffline(String fname) throws PcapException {
		return Pcap0_4.openOffline(Pcap1_9::new, fname);
	}
	 ...
	 * @since libpcap 1.0
	 */
	public static Pcap1_9 create(String device) throws PcapException {
		return Pcap1_0.create(Pcap1_9::new, device);
	}

	/**
	 * Instantiates a new pcap 1 9.
	 *
	 * @param pcapHandle the pcap handle
	 * @param name       the name
	 * @param abi        the abi
	 */
	Pcap1_9(MemorySegment pcapHandle, String name, PcapHeaderABI abi) {
