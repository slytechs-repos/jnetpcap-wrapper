 ...
 */
package com.slytechs.sdk.jnetpcap.windows;

import java.lang.foreign.MemorySegment;
import java.util.concurrent.TimeUnit;

import com.slytechs.sdk.jnetpcap.Pcap0_4;
import com.slytechs.sdk.jnetpcap.Pcap0_6;
import com.slytechs.sdk.jnetpcap.Pcap1_0;
import com.slytechs.sdk.jnetpcap.Pcap1_5;
...
import com.slytechs.sdk.jnetpcap.internal.PcapForeignDowncall;
import com.slytechs.sdk.jnetpcap.internal.PcapForeignInitializer;
 ...
 * <p>
 * Native Npcap is the Nmap Project's packet capture (and sending) library for
 * Microsoft Windows.
 * </p>
 * 
...
public final class Npcap extends WinPcap {
	...
	/**
	 * The Constant pcap_dump_hopen.
	 *
	 * @see {@code pcap_dumper_t *pcap_dump_hopen(pcap_t *, intptr_t)}
	 * @since libpcap 0.9 (Windows only)
	 */
	private static final PcapForeignDowncall pcap_dump_hopen;

	static {
		try (var foreign = new PcapForeignInitializer(Npcap.class)) {
			pcap_dump_hopen = foreign.downcall("pcap_dump_hopen(AA)A"); //$NON-NLS-1$
		}
	}
	 ...
	 * @since libpcap 1.0
	 */
	public static Npcap create(String device) throws PcapException {
		return Pcap1_0.create(Npcap::new, device);
	}
	 ...
	 * @since libpcap 0.6
	 */
	public static Npcap openDead(PcapDlt linktype, int snaplen) throws PcapException {
		return Pcap0_6.openDead(Npcap::new, linktype, snaplen);
	}
	 ...
	 * @since libpcap 1.5.1
	 */
	public static Npcap openDeadWithTstampPrecision(PcapDlt linktype, int snaplen, PcapTStampPrecision precision)
			throws PcapException {
		return Pcap1_5.openDeadWithTstampPrecision(Npcap::new, linktype, snaplen, precision);
	}
	 ...
	 * @since libpcap 0.4
	 */
	public static Npcap openLive(String device,
			int snaplen,
			boolean promisc,
			long timeout,
			TimeUnit unit) throws PcapException {

		return Pcap0_4.openLive(Npcap::new, device, snaplen, promisc, timeout, unit);
	}
	 ...
	 * @since libpcap 0.4
	 */
	public static Npcap openOffline(String fname) throws PcapException {
		return Pcap0_4.openOffline(Npcap::new, fname);
	}

	/**
	 * Instantiates a new Npcap.
	 *
