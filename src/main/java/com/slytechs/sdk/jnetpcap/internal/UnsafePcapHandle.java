...
public class UnsafePcapHandle extends Pcap1_10 {
	 ...
	 * @return the int
	 * @throws PcapException the pcap exception
	 * @see com.slytechs.sdk.jnetpcap.Pcap0_9#inject(java.lang.foreign.MemorySegment, int)
	 */
	@Override
	 ...
	 * @param length the length
	 * @throws PcapException the pcap exception
	 * @see com.slytechs.sdk.jnetpcap.Pcap0_8#sendPacket(java.lang.foreign.MemorySegment, int)
	 */
	@Override
